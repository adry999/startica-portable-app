...
Fereastra Startica folosește profilul separat `Interfata`, fără acces la taburile și extensiile personale Chrome. Acest director conține preferințe/cache pentru interfață, nu baza evidenței. Dacă sunt deschise două ferestre Startica, serverul rămâne pornit până la închiderea ultimei. O oprire forțată a Windows poate împiedica backupul final; fiecare salvare confirmată este deja scrisă în SQLite. Erorile de pornire se găsesc în `Jurnale`.
