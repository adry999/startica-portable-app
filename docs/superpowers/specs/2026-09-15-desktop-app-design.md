...
7. Mutex `Global\Startica_<SHA-256 al căii home, primele 16 hex>` (acoperă și mai multe sesiuni Windows ale aceluiași utilizator). Cine îl obține e **proprietar**. Neproprietarul așteaptă până la 10 s serverul, deschide o fereastră și iese.
