...
Modul **independent**: nu importă alt feature. Copiii vin din `RecordsSnapshot`; câmpurile din editor implementează structural interfața `RecordEditorFields` și sunt injectate de `web/app.js`.
