...
Modul **independent**: nu depinde de `children`/`payments`/`expenses`; primește câmpurile lor deja compuse, prin `fieldsByType`, de la composition root-ul din `src/app/web/main.mjs`.
